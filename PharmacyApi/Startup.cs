    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
         ...
         Newtonsoft.Json.ReferenceLoopHandling.Ignore);
            ...
            services.AddDbContext<PharmacyDataContext>(options => options.
              UseSqlServer(Configuration.GetConnectionString("PharmacyData")));

            services.AddScoped<MedicineInterface, MedicineRepository>();
